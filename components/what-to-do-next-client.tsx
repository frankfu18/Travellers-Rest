  ...
  "first-week": {
    ...
    "what-to-cook": {
      ...
      actions: [
        ...
        "Keep drink inputs separate from food experiments, because food and drink supply are two loops that can accidentally starve each other.",
      ],
    },
    "run-out-stock": {
    ...
    "staff-and-rooms": {
      ...
      actions: [
        ...
        "Treat housekeeper-style help as situational while room count is low; room staff becomes more important after lodging pressure actually grows.",
      ],
    },
  },
  "early-game": {
    "need-money": {
      ...
      actions: [
        "Pick one drink chain such as juice, beer, wine, or ale and keep it stocked for several service days; unstable drink output is one of the easiest early profit bottlenecks to miss.",
        ...
        "Use board orders as a supplemental money and XP source when they fit your production, but do not let them consume the stock needed for your next opening.",
    ...
    "what-to-plant": {
      ...
      actions: [
        ...
        "Treat melons and watermelons as seasonal high-use examples, but check whether they fit your current menu before overplanting.",
    ...
    "staff-and-rooms": {
      ...
      actions: [
        ...
        "Choose bartender, bouncer, or housekeeper priority by pressure point: drink refills, disruptive guests, or room workload.",
      ],
    },
  },
  "mid-game": {
    "need-money": {
      ...
      actions: [
        "Review which stations sit idle and which drinks wait on aging; mid-game planning should shift from unlocking more items to improving throughput.",
    ...
    "what-to-cook": {
      ...
      actions: [
        ...
        "Use cheese platter or rose-style drink examples as advanced value ideas, while avoiding exact value claims until verified.",
    ...
    "run-out-stock": {
      ...
      actions: [
        ...
        "Plan order-board requests separately from tavern demand, because orders, skills, and business needs can compete for the same stock.",
      ],
    },
    "what-to-plant": {
    ...
    "too-busy": {
      ...
      actions: [
        ...
        "Use bouncer-style support when troublesome guests become a repeated operation drain and start pulling attention away from higher-value work.",
    ...
    "staff-and-rooms": {
      ...
      actions: [
        ...
        "Raise housekeeper priority as room count grows, because room staff becomes more valuable once lodging workload is real.",
      ],
    },
  },
  "late-game": {
    ...
    "what-to-cook": {
      ...
      actions: [
        ...
        "Choose foods that raise value, consume existing stock, and do not crush the supply chain.",
      ],
    },
    "run-out-stock": {
    ...
    "need-reputation": {
      ...
      actions: [
        ...
        "Treat shop rating as the result of food, drinks, comfort, and stable hospitality, not customer count alone.",
      ],
    },
    "staff-and-rooms": {
    ...
    <div className="grid gap-6 lg:grid-cols-[360px_1fr]">
      ...
      <section className="rounded-lg border border-amber-200/18 bg-[#1a100b] p-5" aria-live="polite">
        ...
        <p className="mt-3 max-w-3xl text-stone-300">
          These actions are paraphrased from recurring community and guide patterns. They are written as practical planning rules rather than direct quotes or fixed build orders, and they avoid fixed prices or exact balance claims because the game changes over time.
        </p>
