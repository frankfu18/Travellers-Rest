...
export const metadata: Metadata = createMetadata({
  title: "What to Do Next in Travellers Rest - Tavern Strategy Planner",
  description:
    "Choose your Travellers Rest stage and main problem to get practical next actions for money, cooking, stock, crops, reputation, staff, rooms, and tavern expansion.",
      ...
      <section className="border-b border-amber-300/15 bg-[#1a100b]">
        <div className="mx-auto max-w-7xl px-4 py-10 lg:px-6">
          ...
          <p className="mt-4 max-w-3xl text-lg text-stone-300">
            Pick your current stage and main bottleneck to see what to fix before the next opening.
          </p>
          <div className="mt-5 grid max-w-4xl gap-3 text-sm text-stone-300 md:grid-cols-3">
            ...
            <p className="rounded border border-amber-200/15 bg-[#120c08]/70 p-3">
              The page focuses on decisions you can test in your own tavern, not fixed build orders.
            </p>
            <p className="rounded border border-amber-200/15 bg-[#120c08]/70 p-3">
      ...
      <section className="border-t border-amber-300/15 bg-[#1a100b]">
        <div className="mx-auto max-w-7xl px-4 py-10 lg:px-6">
          <div className="wood-panel rounded-lg p-5">
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#f3c35a]">Planning note</p>
            <h2 className="mt-2 text-2xl font-bold text-amber-50">Use This as a Decision Tool</h2>
            <p className="mt-3 max-w-4xl text-stone-300">
              Use these recommendations to choose the next bottleneck to fix, then test the result in one or two openings. If the same shortage, queue, or service delay returns, reduce expansion pressure before adding recipes, staff, rooms, or more seats. Because Travellers Rest is still updated over time, exact item values and balance may change.
            </p>
          </div>
        </div>
      </section>
